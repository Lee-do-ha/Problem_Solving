...
#### 해결 방안
 모든 두 점의 기울기를 비교하러면 시간 복잡도가 O(n^2)가 걸리므로 이 방법으로는 해결할 수가 없다.
![image](https://user-images.githubusercontent.com/122585454/224537157-0782a25e-306d-4b13-8d57-39af83e2e7f5.png)
다음과 같이 두 점A,B 사이에 새로운 점C가 존재한다면 A와 B사이의 기울기는 최대가 될 수 없다
 -> 따라서 인접한 두 점의 기울기만 구하면 된다.
